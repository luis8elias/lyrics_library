...
final darkTheme = ThemeData(
 ...
 final _darkColorScheme = ColorScheme(
  brightness: Brightness.dark,
  primary: const Color.fromARGB(255, 230, 139, 255),
  primaryContainer: const Color.fromARGB(255, 217, 86, 253).withOpacity(0.15),
  onPrimary: const Color(0xff060708),
  secondary: const Color(0xFF636366),
  onSecondary: const Color(0xFFEBEBF5).withOpacity(0.60),
  tertiary: const Color.fromARGB(255, 73, 231, 255),
  error: const Color(0xFFFF675F),
  onError: const Color(0xFFFFFFFF),
  outline: const Color(0xFF8B9198),
  background: const Color(0xff100f11),
  ...
  inverseSurface: const Color(0xFF18181a),
);